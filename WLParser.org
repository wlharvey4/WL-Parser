...
#+macro:version Dev Version 0.2.1
...
.PHONY:	clean clean-world clean-prod check pdf open-pdf
...
prod: clean $(DOCS)
	git checkout dev
	-rm *{.texi,org} lib/check.js docs/.touchstone Makefile
...
$(DOCS): move-info make-pdf

# Create a docs/ dir if necessary; move .info file into it
move-info: docs-dir $(DOCS)/WLParser.info
$(DOCS)/WLParser.info:
	mv -v WLParser.info $(DOCS)

# Create a docs/ dir if necessary; create a .pdf file; move it into docs/
make-pdf: docs-dir $(DOCS)/WLParser.pdf
$(DOCS)/WLParser.pdf:
	pdftexi2dvi -q -c WLParser.texi
	mv -v WLParser.pdf $(DOCS)
...
docs-dir: touchstone
touchstone: $(DOCS)/.touchstone
$(DOCS)/.touchstone:
	mkdir -vp $(DOCS)
	touch $(DOCS)/.touchstone
