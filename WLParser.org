...
#+BEGIN_SRC js -n :tangle index.js
  ...
  module.exports = {
      WLRecord: require('./lib/wl_record'),
      WLReader: require('./lib/wl_reader'),
      WLType:   require('./lib/wl_type'),
      WLChecks: require('./lib/wl_checks')
  };
#+END_SRC
...
#+header: :mkdirp yes
#+begin_src js -n :tangle lib/wl_re.js
  /* wl_re.js */
...
#+header: :mkdirp yes
#+begin_src js :tangle lib/wl_record.js
  /* wl_record.js */
...
#+begin_src js -n :tangle __tests__/wl_record.test.js
      const Parser = require('../lib/wl_record');
...
#+begin_src js -n :tangle lib/check.js
  const {wl_re, WL_COMPONENTS} = require('../lib/wl_re.js');
...
#+name:WLReader-class
#+header: :mkdirp yes
#+begin_src js -n :tangle lib/wl_reader.js
    /* wl_reader.js */
...
#+begin_src js -n :tangle __tests__/wl_reader.test.js
  ...
  const path    = require('path');
  const WLR     = require('../lib/wl_reader');
  const WLRecord= require('../lib/wl_record');
  const WORKLOG = process.env.WORKLOG;
...
#+name:WLType-module
#+begin_src js -n :tangle lib/wl_type.js
  /* wl_data.js */
...
#+begin_src js -n :tangle __tests__/wl_type.test.js
  ...
  const WLType = require('../lib/wl_type');
  const {wl_re, WL_COMPONENTS} = require('../lib/wl_re');
  const YEAR     = (new Date()).getUTCFullYear();
  const REC_SEP  = /^$/;
...
#+begin_src js -n :tangle lib/wl_checks.js
  /* wl_check.js */
...
#+begin_src js -n :tangle __tests__/wl_checks.test.js
  ...
  const WLChecks = require('../lib/wl_checks');
  const YEAR     = new Date().getUTCFullYear();
  //const REC_SEP  = /^$/;
